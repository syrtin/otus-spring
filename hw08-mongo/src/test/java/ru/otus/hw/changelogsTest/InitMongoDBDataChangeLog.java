...
public class InitMongoDBDataChangeLog {
    ...
    public static final String THIRD_COMMENT_ID = ObjectId.get().toString();
    ...
    public void insertGenres(GenreRepository repository) {
        genre1 = repository.save(new Genre(FIRST_GENRE_ID, "Genre_1"));
        genre2 = repository.save(new Genre(SECOND_GENRE_ID, "Genre_2"));
    ...
    public void insertBooks(BookRepository repository) {
        book1 = repository.save(new Book(FIRST_BOOK_ID,"BookTitle_1", author1, Arrays.asList(genre1, genre2)));
    ...
    public void insertComments(CommentRepository repository) {
        repository.save(new Comment(FIRST_COMMENT_ID, "Comment_1", book1));
        repository.save(new Comment(ObjectId.get().toString(), "Comment_2", book2));
        repository.save(new Comment(THIRD_COMMENT_ID, "Comment_3", book1));
    }
}
